...
void MainWindow::initToolbar(int session)
{
    ...
    loginAct = util.makeAction("","로그인(L)","Ctrl+L","로그인을 시작합니다.",this,SLOT(startLogin()));
    logoutAct = util.makeAction("","로그아웃(L)","Ctrl+L","로그아웃합니다.",this,SLOT(startLogout()));
    exitAct = util.makeAction("","종료(Q)","Ctrl+Q","회원을 새롭게 추가합니다.",this,SLOT(startExit()));
